...
const Game = props => {
  ...
  return /*#__PURE__*/React.createElement("div", null, props.crd[0] === props.bracketLength - 1 ? /*#__PURE__*/React.createElement("h3", {
    ...
    style: props.crd[0] === 0 && !props.teams[0].id ? emptyGamesStyle : gamesStyle
  }, /*#__PURE__*/React.createElement("div", {
    style: gamesDivStyleTop
  }, /*#__PURE__*/React.createElement("div", {
    style: leftDivStyle
  }, props.teams[0].name), /*#__PURE__*/React.createElement("div", {
    style: props.score[0] > props.score[1] ? winningScoreStyle : {}
    ...
    style: props.score[1] > props.score[0] ? winningScoreStyle : {}
  }, props.score[1]))));
};
